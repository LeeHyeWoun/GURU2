        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(edtName.getText().toString().equals("")
                    ...
                    Toast.makeText(getActivity(), "생년을 다시 확인해 주세요.",Toast.LENGTH_SHORT).show();}
                else if(Integer.parseInt(edtMm.getText().toString())<1 || Integer.parseInt(edtMm.getText().toString())>12 ){
                    Toast.makeText(getActivity(), "생월을 다시 확인해 주세요.",Toast.LENGTH_SHORT).show();}
                else if(Integer.parseInt(edtDd.getText().toString())<1 || Integer.parseInt(edtDd.getText().toString())>31 ){
                    Toast.makeText(getActivity(), "생일을 다시 확인해 주세요.",Toast.LENGTH_SHORT).show();}
